 ...
 */
export class TopKWithFractionalIndexOperatorOld<K, V1> extends UnaryOperator<
  [K, V1],
  [K, [V1, string]]
> {
 ...
 */
export function topKWithFractionalIndexOld<
...
>(
  ...
  return (
    ...
    const operator = new TopKWithFractionalIndexOperatorOld<K, V1>(
